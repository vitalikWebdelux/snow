...
module.exports = {
	...
	// Project options.
	projectURL: 'https://tehnodim', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	productURL: './', // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.
	browserAutoOpen: true,
	injectChanges: true,

	// Style options.
	styleSRC: '../src/sass/main.sass', // Path to main .sass file.
	...
	// JS Vendor options.
	jsVendorSRC: '../src/libs/*.js', // Path to JS vendor folder.
	...
	watchJsVendor: '../src/libs/**/*.js', // Path to all vendor JS files.
