...
add_filter( 'dynamic_sidebar_params', 'sd_widget_classes' );

if ( ! function_exists( 'sd_widget_classes' ) ) {
	/**
	 * Count number of visible widgets in a sidebar and add classes to widgets accordingly,
	 * so widgets can be displayed one, two, three or four per row.
	 */
	function sd_widget_classes( $params ) {
...
if ( ! function_exists( 'ch_widgets_init' ) ) {
	/**
	...
	function ch_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'tehnodim' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'tehnodim' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'tehnodim' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'tehnodim' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer', 'tehnodim' ),
				'id'            => 'footer-full',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'tehnodim' ),
